package com.example.producer3.config;
...
public class MessagingConfig {
    ...
    public static final String HOST_NAME = "sparrow-01.rmq.cloudamqp.com";
    public static final String USERNAME = "jjxruqxp";
    public static final String PASSWORD = "OFxA_s388IUxC8KvGymve4GmFxvlwlvP";
